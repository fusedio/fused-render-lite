...
from fused_render_app._web import APIRouter, Body, Header, Request
from fused_render_app._web import (
    FileResponse,
    HTMLResponse,
    JSONResponse,
    RedirectResponse,
...
from fused_render_app import claude_health, jobs
from fused_render_app.ai.runners import formats
from fused_render_app.routes import ai_metrics
...
from fused_render_app.shell.prefs import default_model
...
def _local_default_model() -> str | None:
    ...
    from fused_render_app.ai import catalog, registry
...
def _images_unsupported_by_runner(model: str) -> str | None:
    ...
    """
    from fused_render_app.ai import registry
    from fused_render_app.routes import ai_routes as ai_runtime
...
async def _ai_relay(body: dict, session: "_AiSession | None" = None, page: str = ""):
    ...
    # Bottom-right activity notification (fused_render_app/jobs.py's registry —
