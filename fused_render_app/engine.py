"""The fused execution engine is not part of fused-render-app. The copied
...
3.12, or this interpreter — which is what Render App wants."""
...
class _NoBackend:
    ...
    def _python_executable(self):
        ...
        None for "this interpreter" when it already runs 3.12 (the packaged
        app's bundled python included), else a uv-managed 3.12."""
...
def app_satisfies(requirements: list) -> bool:
    """Render App's own interpreter is stdlib-only and never runs project code, so it
