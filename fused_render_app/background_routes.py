...
`server/routers/background_apps.py` and `routers/engines.py` onto Render App's
...
from fused_render_app import background_apps, engine_forward, engine_host
...
def _folder_for(html) -> str | None:
    ...
    from fused_render_app.server import app_dir_for
