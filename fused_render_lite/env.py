...
# set, so lite installs it once, on demand, into one shared venv.
LEGACY_DEPS = (
    "numpy",
    "pandas",
    "requests",
...
LEGACY_DEPS_ENV = "FUSED_RENDER_LITE_LEGACY_DEPS"  # comma list override (tests)
