...
from fused_render_lite import dock_store, server
from fused_render_lite.cli import open_url
from fused_render_lite.mainwindow import USER_AGENT_MARKER, _open_external
...
class DockController:
    ...
    def _show_utility_menu(self) -> None:
        menu = NSMenu.alloc().initWithTitle_("Render Lite")
        ...
        menu.addItem_(NSMenuItem.separatorItem())
        item("Quit Render Lite", b"quitApp:", "q")
    ...
    def _build_panel(self) -> None:
        ...
        # its own glass when it sees "RenderLite/" in the UA.
        config.setApplicationNameForUserAgent_(f"{USER_AGENT_MARKER} RenderLiteDock")
        try:
