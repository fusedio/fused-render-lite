...
**Stdlib, numpy and sherpa-onnx only — no import of `fused_render_lite`.** The same
...
# is `fused_render_lite.ai.runners.diarize` and the package-relative import is the
