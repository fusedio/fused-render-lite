"""User-data dir (~/.fused-render-lite) and atomic JSON I/O.
...
def home_dir() -> str:
    """fused-render-lite's state dir (``~/.fused-render-lite``, or
    ``FUSED_RENDER_LITE_HOME``). The AI subsystem keeps its caches, worker
